(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('konva/lib/shapes/Line'), require('konva/lib/shapes/Rect'), require('konva/lib/shapes/Text'), require('konva/lib/Core'), require('konva/lib/Animation'), require('waveform-data')) :
  typeof define === 'function' && define.amd ? define(['konva/lib/shapes/Line', 'konva/lib/shapes/Rect', 'konva/lib/shapes/Text', 'konva/lib/Core', 'konva/lib/Animation', 'waveform-data'], factory) :
...
})(this, (function (Line, Rect, Text, Konva, Animation, WaveformData) { 'use strict';
  ...
  function HighlightLayer(view, offset, color) {
    ...
    this._offset = offset;
    this._color = color;
    this._layer = new Konva__default["default"].Layer({
      listening: false
    });
  ...
  function getMarkerObject(obj) {
    while (obj.parent !== null) {
      if (obj.parent instanceof Konva__default["default"].Layer) {
        return obj;
      }
  ...
  function PlayheadLayer(options) {
    ...
    this._playheadLayer = new Konva__default["default"].Layer();
  ...
  PlayheadLayer.prototype._createPlayhead = function (color) {
    ...
    this._playheadGroup = new Konva__default["default"].Group({
      x: 0,
      y: 0
    });
  ...
  PlayheadLayer.prototype._createPlayheadText = function (color) {
    ...
    this._playheadText = new Text.Text({
      x: 2,
      y: 0,
      text: text,
  ...
  function PointMarker(options) {
    ...
    this._group = new Konva__default["default"].Group({
  ...
  function WaveformShape(options) {
    ...
    this._shape = new Konva__default["default"].Shape(shapeOptions);
    this._view = options.view;
    this._segment = options.segment;
  ...
  function WaveformOverview(waveformData, container, peaks) {
    ...
    Konva__default["default"].showWarnings = false;
    self._resizeTimeoutId = null;
    self._stage = new Konva__default["default"].Stage({
      container: container,
      width: self._width,
      height: self._height
    });
    self._waveformLayer = new Konva__default["default"].Layer({
      listening: false
    });
  ...
  function getOverviewOptions(opts) {
    ...
    var optNames = ['container', 'waveformColor', 'playedWaveformColor', 'playheadColor', 'playheadTextColor', 'formatPlayheadTime', 'timeLabelPrecision', 'axisGridlineColor', 'showAxisLabels', 'axisLabelColor', 'formatAxisTime', 'fontFamily', 'fontSize', 'fontStyle', 'highlightColor', 'highlightOffset'];
